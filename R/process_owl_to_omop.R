...
#' `dev`.
#'
#' @param inst_folder Installation folder that will include the zipped versions of the Neo4j and OMOP
#' csvs in deployed packages
#'
#'
#' @return
#' CSV files
...
#' CONCEPT:
#' The
#' `concept_class_id` are dependent on the placement of the hierarchy. If it is
#' the topmost ancestor, it is 'Root' Class. If it is a bottom-most descendant, it is
