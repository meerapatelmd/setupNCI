...
concept_class_map <-
  tibble::tribble(
    ~`domain_id_1`, ~`concept_class_1`, ~`relationship_id`, ~`is_hierarchical`, ~`domain_id_2`, ~`concept_class_2`, ~`standard_concept_1`, ~`standard_concept_2`,
    ...
    'Observation','CTCAE 5 Parent','Has_CTCAE_5_Parent',0,'Observation','CTCAE 5 Child','C','C'
  )
